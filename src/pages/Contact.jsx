...
function Contact() {
  return (
    <main>
      ...
      {/*Contact form*/}
      <div className="px-20  lg:h-[100vh] relative ">
        <div className="container w-[100%] lg:h-[28vh] bg-[#005637] rounded-2xl "></div>
        {/*Form container*/}
        <div className="  absolute lg:left-25 lg:right-25  lg:bottom-[45px] grid grid-cols-3 mx-16 rounded-md  shadow-[0_12px_35px_rgba(0,0,0,0.14)] bg-gray-50">
          {/*Left side of form area*/}
          <div className=" container bg-[#005637] lg:px-12  w-full h-full rounded-md text-white shadow-[0_12px_35px_rgba(0,0,0,0.20)] flex lg:flex-col lg:items-center lg:justify-center">
            <h4 className="font-bold lg:text-[20px] pb-3">Contact info</h4>
            <div>
              <p className="text-center pb-4 text-[15px]">
                Chamabondo learners engage in hands-on projects that spark
                creativity and build confidence. From science experiments to
                art{" "}
              </p>

              <div className="pb-4 flex text-[14px]">
                <svg
              ...
              <div className="pb-4 text-[14px] flex ">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
          ...
          {/*Right side of form area*/}
          <div className="col-span-2 px-8 py-10 ">
            <h3 className="font-semibold text-xl mb-6 lg:text-2xl 2xl:text-3xl">
              Contact Us
            </h3>
            <div>
              <label
                for="last-name"
                class="block text-sm/6 font-semibold italic text-black"
              >
                Name
              </label>
              <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
              <label
                for="email"
                class="block text-sm/6 font-semibold text-black italic"
              >
                Email
              </label>
              <div class="mt-2.5">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2.5">
                <div class="flex  w-full outline-hidden border-b-2 border-[#005637] bg-gray-50 px-3.5 py-2 text-base text-gray-900 outline-1 placeholder:text-gray-400 focus:outline-2  focus:outline-indigo-600">
                  <div class="grid shrink-0 grid-cols-1 focus-within:relative">
                    <select
                      ...
                      aria-label="Country"
                      class="col-start-1 row-start-1 w-full appearance-none rounded-md py-2 pr-7 pl-3.5 text-base text-gray-500 placeholder:text-gray-400  focus:outline-indigo-600 sm:text-sm/6"
                    >
                      <option>ZW</option>
                      <option>ZM</option>
                    </select>
